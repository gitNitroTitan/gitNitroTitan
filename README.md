...
- 🔭 I am constantly coding new projects in a large enterprise appilcation built with Angular and .NET.

- 🌱 I’m currently growing with C#/ .NET. I have a great grasp of HTML, CSS, JavaScript, ReactJS, Google Firebase storage and authentication, GitHub Team Workflow, deployment utilizing Netlify, using webpack, modularization of code, Bootstrap 5, React Boostrap, AngularJS, Angular 2+, some C# and SQL using SSMS.
